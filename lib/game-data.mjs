...
export function validateGame(game) {
  ...
  const genres=normalizeGenres(game.genres);if(!genres.length || genres.length>30)throw new Error('Choose between 1 and 30 genres.');
  return {...game,title:game.title.trim(),videoId:videoID(game.videoId),genres};
}
